      ...
      <div className="max-w-3xl mx-auto flex items-end gap-2">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-gray-300 px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50 disabled:text-gray-400 min-h-[48px] max-h-[200px]"
            dir="rtl"
          />
        </div>
