...
5. اقترح أفكاراً للـ الهاشتاغات والـ خطافات المناسبة للمنشور.

مهمتك: مساعدة المستخدم كمستشاره الشخصي على تحويل أفكاره الخام إلى محتوى مهني ذات تأثير على لينكد.`;
};
